    ...
    <div className="product-container">
          ...
          <div className="hero-copy">
            ...
            <h1 className="hero-title">
              <span className="word-reveal">
                <motion.span initial={{ opacity: 0, y: 40 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.08 }}>Observe </motion.span>
                <motion.span initial={{ opacity: 0, y: 40 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.16 }}>everything. </motion.span>
              </span>
              <br />
              <span className="word-reveal">
                <motion.span initial={{ opacity: 0, y: 40 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.24 }}>Debug </motion.span>
                <motion.span initial={{ opacity: 0, y: 40 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.32 }} className="text-cyan">anything.</motion.span>
              </span>
            </h1>
            ...
            >
              Unified metrics, distributed traces, and structured logs — powered by OpenTelemetry. Built for engineers who need answers in seconds, not hours.
            </motion.p>
            ...
            >
              ...
              <button className="btn-ghost" onClick={() => window.open('https://youtube.com', '_blank')}>
            ...
            >
              <span className="trust-pill"><Check size={12} className="text-cyan" /> OTel Compatible</span>
              <span className="trust-pill"><Check size={12} className="text-cyan" /> Self-Hosted</span>
              <span className="trust-pill"><Check size={12} className="text-cyan" /> Real-time</span>
              <span className="trust-pill"><Check size={12} className="text-cyan" /> Multi-tenant</span>
            </motion.div>
          </div>
      ...
      <section className="ticker-section">
        ...
        <div className="ticker-track">
          <div className="ticker-content">
            {['Stripe', 'Vercel', 'Notion', 'Linear', 'Figma', 'Shopify', 'Cloudflare', 'Stripe', 'Vercel', 'Notion', 'Linear', 'Figma'].map((name, i) => (
      ...
      >
        <div className="section-header center">
          ...
          <p className="section-subtitle">Dense information, zero fluff. Every screen designed to answer your question in seconds.</p>
        </div>
        ...
        <div className="tour-tabs">
          {(['overview', 'traces', 'map'] as const).map(tab => (
            ...
            >
              {activeTab === tab && <motion.div layoutId="tour-indicator" className="tour-indicator" />}
      ...
      <section className="features-section">
        <div className="features-grid">
          {[
            ...
            >
              <div className="feature-icon-box"><Check size={18} className="text-indigo" /></div>
              <h3 className="feature-title">{f.title}</h3>
              <p className="feature-desc">{f.desc}</p>
              <a href="#" className="feature-link">Learn more <ChevronRight size={14} /></a>
            </motion.div>
          ))}
        </div>
      </section>
      ...
      >
        <div className="otel-grid">
          <div className="otel-copy">
            <div className="hero-badge" style={{ marginBottom: 24 }}>• CLIENT SDKs</div>
            ...
            <p className="section-subtitle" style={{ textAlign: 'left', margin: '0 0 32px 0' }}>
              Optikk is built on OpenTelemetry — the industry standard. Use the official OTel SDKs you already know. No proprietary agents. No vendor lock-in. Your data, your way.
            </p>
            <ul className="otel-checklist">
              <li><Check size={16} className="text-cyan" /> <span><strong>Zero-config tracing</strong> — automatic span propagation across HTTP and gRPC</span></li>
              <li><Check size={16} className="text-cyan" /> <span><strong>Structured log shipping</strong> — JSON logs with automatic trace correlation</span></li>
              <li><Check size={16} className="text-cyan" /> <span><strong>Custom metrics</strong> — counters, histograms, gauges with exemplar support</span></li>
              <li><Check size={16} className="text-cyan" /> <span><strong>OTLP native</strong> — drop-in replacement for any OTel-compatible backend</span></li>
            </ul>
          </div>
...
tracer = trace.get_tracer("my-service")`
                ...
                {
                  id: 'java', label: 'Java', language: 'java', code: `OpenTelemetrySdk.builder()
    .setTracerProvider(
        ...
        <div className="selfhost-grid">
          <div className="selfhost-copy">
            ...
            <p className="selfhost-desc">
              No SaaS subscription, no per-seat pricing, no data leaving your network. Deploy the full stack in 5 minutes with our official docker-compose setup.
            </p>
            <div className="selfhost-ctas">
              <a href="https://github.com/optikk-org" target="_blank" rel="noreferrer" className="btn-ghost">
              ...
              <a href="https://docs.optikk.io" target="_blank" rel="noreferrer" className="text-link">
          ...
          <div className="selfhost-code component-card" style={{ padding: 16 }}>
            ...
            <CodeTabs tabs={[{ id: 'yaml', label: 'docker-compose.yml', language: 'yaml', code: DOCKER_CMD }]} />
          </div>
        </div>
      </motion.section>
