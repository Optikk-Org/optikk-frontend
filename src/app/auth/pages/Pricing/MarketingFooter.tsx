    ...
    >
      ...
      <div className="footer-grid">
        ...
        <div>
          ...
          >
            Full-stack observability for engineering teams. Navigate from high-level metrics down to
            single code lines in seconds.
          </p>
          <div
            style={{
              display: 'flex',
        ...
        <div>
          ...
          <Link to="/self-host" className="footer-link">
            Self-host
          </Link>
