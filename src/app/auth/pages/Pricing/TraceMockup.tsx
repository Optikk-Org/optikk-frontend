...
const TRACES: TraceRow[] = [
  { service: 'api-gateway',    duration: 312, maxDuration: 312, status: 200, color: '#6366F1', spans: 8 },
  { service: 'auth-service',   duration: 187, maxDuration: 312, status: 200, color: '#22D3EE', spans: 3 },
  { service: 'payment-svc',    duration: 241, maxDuration: 312, status: 200, color: '#10B981', spans: 5 },
  { service: 'postgres-proxy', duration: 98,  maxDuration: 312, status: 200, color: '#8B5CF6', spans: 2 },
  { service: 'redis-cache',    duration: 14,  maxDuration: 312, status: 200, color: '#F59E0B', spans: 1 },
  { service: 'notification',   duration: 156, maxDuration: 312, status: 500, color: '#EF4444', spans: 4 },
  { service: 'billing-worker', duration: 203, maxDuration: 312, status: 200, color: '#06B6D4', spans: 6 },
