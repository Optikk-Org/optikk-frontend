...
import { boardHeight } from '@components/common/data-display/ObservabilityDataBoard';
import ObservabilityDataBoard from '@components/common/data-display/ObservabilityDataBoard';


function deriveNodeStatus(errorRate: any) {
        ...
        filters={[
          {
            ...
            value: hostFilter,
            onChange: (val: any) => setHostFilter(val),
            width: 240,
          },
        ]}
      />
