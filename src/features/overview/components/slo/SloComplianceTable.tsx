      ...
      render: (value: any) => {
        ...
        return (
          <span
            style={{
              color:
                normalized >= availabilityTarget ? APP_COLORS.hex_12b76a : APP_COLORS.hex_f04438,
              fontWeight: 700,
            }}
          >
          ...
          <Badge
            ...
            style={{
              background: compliant
                ...
                : APP_COLORS.rgba_240_68_56_0p12_2,
    ...
    <Surface elevation={1} padding="md">
      ...
      {isLoading ? (
        ...
        <SimpleTable
          ...
          dataSource={timeseries.map((row: any, index: number) => ({
            ...row,
            key: `slo-${index}`,
          }))}
          rowKey="key"
