...
const variantClasses: Record<BadgeVariant, string> = {
  ...
  success:
    'bg-[rgba(82,135,107,0.15)] text-[var(--color-success)] border-[rgba(82,135,107,0.3)]',
  error:
    'bg-[rgba(220,38,38,0.12)] text-[var(--color-error)] border-[rgba(220,38,38,0.3)]',
  warning:
    'bg-[rgba(217,119,6,0.12)] text-[var(--color-warning)] border-[rgba(217,119,6,0.3)]',
  info:
    'bg-[rgba(77,166,200,0.12)] text-[var(--color-info)] border-[rgba(77,166,200,0.3)]',
};

const colorClasses: Record<string, string> = {
  blue: 'bg-[rgba(59,130,246,0.12)] text-[#3B82F6] border-[rgba(59,130,246,0.3)]',
  purple:
    'bg-[rgba(94,96,206,0.12)] text-[#7C7FF2] border-[rgba(94,96,206,0.3)]',
  green:
    'bg-[rgba(82,135,107,0.15)] text-[#52876B] border-[rgba(82,135,107,0.3)]',
