 ...
 */
export function asUserId(id: string | number): UserId { return id as UserId; }
export function asTeamId(id: number): TeamId { return id as TeamId; }
export function asTraceId(id: string): TraceId { return id as TraceId; }
export function asSpanId(id: string): SpanId { return id as SpanId; }
export function asMetricId(id: string): MetricId { return id as MetricId; }
export function asLogId(id: string): LogId { return id as LogId; }
