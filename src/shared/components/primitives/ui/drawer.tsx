...
const DrawerOverlay = ({
  ...
  <DrawerPrimitive.Overlay className={cn('fixed inset-0 z-50 bg-black/50', className)} {...props} />
);
...
const DrawerContent = ({
  ...
  <DrawerPortal>
    ...
    <DrawerPrimitive.Content
      className={cn('fixed z-50 flex h-full flex-col bg-[var(--bg-card,#fff)]', className)}
