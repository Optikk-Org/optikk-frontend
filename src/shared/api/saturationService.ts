...
export const saturationService = {
  ...
  async getProduceRateByTopic(
    ...
    return api.get(`${BASE}/saturation/kafka/produce-rate-by-topic`, {
  ...
  async getPublishLatencyByTopic(
    ...
    return api.get(`${BASE}/saturation/kafka/publish-latency-by-topic`, {
      params: { startTime, endTime },
    });
  },
  ...
  async getConsumeRateByTopic(
    ...
    return api.get(`${BASE}/saturation/kafka/consume-rate-by-topic`, {
      params: { startTime, endTime },
    });
  },
  ...
  async getReceiveLatencyByTopic(
    ...
    return api.get(`${BASE}/saturation/kafka/receive-latency-by-topic`, {
      params: { startTime, endTime },
    });
  },
  ...
  async getConsumeRateByGroup(
    ...
    return api.get(`${BASE}/saturation/kafka/consume-rate-by-group`, {
      params: { startTime, endTime },
    });
  },
  ...
  async getProcessRateByGroup(
    ...
    return api.get(`${BASE}/saturation/kafka/process-rate-by-group`, {
      params: { startTime, endTime },
    });
  },
  ...
  async getProcessLatencyByGroup(
    ...
    return api.get(`${BASE}/saturation/kafka/process-latency-by-group`, {
      params: { startTime, endTime },
    });
  },
  ...
  async getConsumerLagPerPartition(
    ...
    return api.get(`${BASE}/saturation/kafka/lag-per-partition`, {
      params: { startTime, endTime },
    });
  },
  ...
  async getRebalanceSignals(
    ...
    return api.get(`${BASE}/saturation/kafka/rebalance-signals`, {
      params: { startTime, endTime },
    });
  },
  ...
  async getBrokerConnections(
    ...
    return api.get(`${BASE}/saturation/kafka/broker-connections`, {
      params: { startTime, endTime },
    });
  },
  ...
  async getClientOperationDuration(
    ...
    return api.get(`${BASE}/saturation/kafka/client-op-duration`, {
      params: { startTime, endTime },
    });
  },
  ...
  async getDatabaseQueryByTable(
    ...
    return api.get(`${BASE}/saturation/database/query-by-table`, {
      params: { startTime, endTime },
    });
  },
  ...
  async getDatabaseCacheSummary(
    ...
    return api.get(`${BASE}/saturation/database/latency-summary`, {
      params: { startTime, endTime },
    });
  },
